...
class GeyserStub:
    ...
    def __init__(self, channel):
        ...
        self.SubscribeDeshred = channel.stream_stream(
                ...
                _registered_method=True)
        self.SubscribeGossip = channel.unary_stream(
                '/geyser.Geyser/SubscribeGossip',
                request_serializer=geyser__pb2.SubscribeGossipRequest.SerializeToString,
                response_deserializer=geyser__pb2.SubscribeUpdateGossip.FromString,
                _registered_method=True)
...
class GeyserServicer:
    ...
    def SubscribeGossip(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_GeyserServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SubscribeGossip': grpc.unary_stream_rpc_method_handler(
                    servicer.SubscribeGossip,
                    request_deserializer=geyser__pb2.SubscribeGossipRequest.FromString,
                    response_serializer=geyser__pb2.SubscribeUpdateGossip.SerializeToString,
            ),
...
class Geyser:
    ...
    def SubscribeGossip(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/geyser.Geyser/SubscribeGossip',
            geyser__pb2.SubscribeGossipRequest.SerializeToString,
            geyser__pb2.SubscribeUpdateGossip.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
